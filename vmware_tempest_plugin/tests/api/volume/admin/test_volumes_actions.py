...
Created Time: Wed 31 Aug 2016 02:58:16 PM CST
File Name   : test_volumes_actions.py
Description : 
'''
...
class VolumesActionsV2Test(base.VmwareBaseVolumeAdminTest):
    ...
    def setup_clients(cls):
        ...
        cls.client = cls.volumes_vmware_client
    ...
    def test_volume_reset_status(self):
        ...
        volume_get = self.admin_volume_vmware_client.show_volume(
